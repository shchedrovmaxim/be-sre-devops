...
> Read this first. Once the in-house badge office analogy clicks, the [deep-dive doc](./vault-pki.md) makes a lot more sense.
...
When the badge-office analogy is clear and you can name the two K8s integration patterns without hesitation, jump to [`vault-pki.md`](./vault-pki.md). The deep-dive covers:
