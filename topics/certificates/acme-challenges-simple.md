...
> Read this first. Once the two-proof analogy clicks, the [deep-dive doc](./acme-challenges.md) has the exact mechanics and infra requirements for each type.
...
When the front-door vs registry analogy is clear and you can name the infra requirements for each type without hesitation, jump to [`acme-challenges.md`](./acme-challenges.md). The deep-dive covers:
