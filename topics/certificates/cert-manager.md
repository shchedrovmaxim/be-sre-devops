...
> Start with [cert-manager-simple.md](./cert-manager-simple.md) if you haven't read it. The paperwork assembly-line analogy is the spine of everything here.
...
- `vault`: signs via Vault PKI secrets engine. See [vault-pki.md](./vault-pki.md).
