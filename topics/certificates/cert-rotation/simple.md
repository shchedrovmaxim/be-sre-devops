...
> Read this first. Once the passport analogy clicks, the [deep-dive doc](./deep-dive.md) covers the exact tooling and the famous outage patterns.
...
When the passport analogy is clear and you can name both monitoring layers without prompting, jump to [`cert-rotation.md`](./deep-dive.md). The deep-dive covers:
