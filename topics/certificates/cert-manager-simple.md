...
> Read this first. Once the assembly-line analogy clicks, the [deep-dive doc](./cert-manager.md) is a lot easier to follow.
...
When you can describe the CRD chain without looking it up, jump to [`cert-manager.md`](./cert-manager.md). The deep-dive covers:
