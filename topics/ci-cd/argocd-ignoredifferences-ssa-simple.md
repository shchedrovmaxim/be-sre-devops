...
> Read this first. Once the analogy clicks, the [deep-dive](./argocd-ignoredifferences-ssa.md) is easy.
...
When the shared-whiteboard analogy feels obvious, jump to [`argocd-ignoredifferences-ssa.md`](./argocd-ignoredifferences-ssa.md). The deep-dive covers:
