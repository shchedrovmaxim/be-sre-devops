...
> Read this first. Once the analogy clicks, the [deep-dive](./opa-gatekeeper.md) is easy.
...
When the law-library analogy feels obvious, jump to [`opa-gatekeeper.md`](./opa-gatekeeper.md). The deep-dive covers:
