...
> Read this first. Once the analogy clicks, the [deep-dive](./image-scanning.md) is easy.
...
When the health-inspector analogy feels obvious, jump to [`image-scanning.md`](./image-scanning.md). The deep-dive covers:
