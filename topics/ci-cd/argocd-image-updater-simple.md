...
> Read this first. Once the analogy clicks, the [deep-dive](./argocd-image-updater.md) is easy.
...
When the price-tag-updater analogy feels obvious, jump to [`argocd-image-updater.md`](./argocd-image-updater.md). The deep-dive covers:
