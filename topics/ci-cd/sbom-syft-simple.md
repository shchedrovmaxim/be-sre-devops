...
> Read this first. Once the analogy clicks, the [deep-dive](./sbom-syft.md) is easy.
...
When the ingredient-label analogy feels obvious, jump to [`sbom-syft.md`](./sbom-syft.md). The deep-dive covers:
