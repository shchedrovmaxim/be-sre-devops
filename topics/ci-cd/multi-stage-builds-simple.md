...
> Read this first. Once the intuition clicks, the [deep-dive doc](./multi-stage-builds.md) becomes obvious.
...
When the kitchen analogy feels obvious, jump to [`multi-stage-builds.md`](./multi-stage-builds.md). The deep-dive covers:
