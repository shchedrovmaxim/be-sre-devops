...
> Read this first. Once the analogy clicks, the [deep-dive doc](./priority-preemption.md) becomes easy.
...
When the airport analogy clicks and you understand the PDB-doesn't-block-preemption gotcha, jump to [`priority-preemption.md`](./priority-preemption.md). The deep-dive covers:
