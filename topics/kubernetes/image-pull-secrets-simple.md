...
> Read this first. Once the analogy clicks, the [deep-dive doc](./image-pull-secrets.md) becomes easy.
...
When the membership card analogy feels obvious, jump to [`image-pull-secrets.md`](./image-pull-secrets.md). The deep-dive covers:
