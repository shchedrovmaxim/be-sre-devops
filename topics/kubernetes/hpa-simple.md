...
> Read this first. Once the analogy clicks, the [deep-dive doc](./hpa.md) becomes easy.
...
When the thermostat analogy clicks, jump to [`hpa.md`](./hpa.md). The deep-dive covers:
