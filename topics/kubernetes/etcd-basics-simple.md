...
> Read this first. Once the analogy clicks, the [deep-dive doc](./etcd-basics.md) becomes easy.
...
When the city hall analogy feels obvious, jump to [`etcd-basics.md`](./etcd-basics.md). The deep-dive covers:
