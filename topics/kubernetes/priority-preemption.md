...
> Start with the [simple version](./priority-preemption-simple.md) if you haven't read it. The airport boarding-priority analogy is the spine of this topic.
...
For node-pressure eviction, see [resource-mgmt-requests-limits.md](./resource-mgmt-requests-limits.md).
