...
> Read this first. Once the analogy clicks, the [deep-dive doc](./resource-mgmt-requests-limits.md) becomes easy.
...
When the restaurant analogy clicks and you understand the three QoS classes, jump to [`resource-mgmt-requests-limits.md`](./resource-mgmt-requests-limits.md). The deep-dive covers:
