...
> Read this first. Once the analogy clicks, the [deep-dive doc](./statefulset.md) becomes easy.
...
When the reserved-seat analogy clicks, jump to [`statefulset.md`](./statefulset.md). The deep-dive covers:
