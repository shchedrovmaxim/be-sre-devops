...
> Read this first. Once the analogy clicks, the [deep-dive doc](./control-plane.md) becomes easy.
...
When the kitchen analogy feels obvious, jump to [`control-plane.md`](./control-plane.md). The deep-dive covers:
