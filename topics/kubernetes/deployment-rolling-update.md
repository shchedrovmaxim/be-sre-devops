...
> Start with the [simple version](./deployment-rolling-update-simple.md) if you haven't read it. The relay-race analogy is the spine of this whole topic.
...
- `preStop: sleep 10` is still needed here (kube-proxy convergence). See [pod-lifecycle.md](./pod-lifecycle.md).
