...
> Read this first. Once the analogy clicks, the [deep-dive doc](./services.md) becomes easy.
...
- [Deep-dive: services.md](./services.md) — covers kube-proxy modes (iptables vs IPVS vs eBPF), the DNAT flow, externalTrafficPolicy hop trade-off, sessionAffinity, and Headless services for StatefulSets

## Next: the deep-dive

When the reception desk analogy feels obvious, jump to [`services.md`](./services.md). The deep-dive covers:
