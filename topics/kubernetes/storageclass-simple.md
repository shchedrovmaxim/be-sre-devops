...
> Read this first. Once the analogy clicks, the [deep-dive doc](./storageclass.md) becomes easy.
...
- [Deep-dive: storageclass.md](./storageclass.md) — covers the full field reference, the default class annotation, topology constraints, reclaim policies in detail, and the `mountOptions` field
