...
- [Deep-dive: volume-expansion.md](./deep-dive.md) — covers the controller and node resize gRPC calls in detail, online vs offline resize, the partial-resize state detection, and driver-specific gotchas
