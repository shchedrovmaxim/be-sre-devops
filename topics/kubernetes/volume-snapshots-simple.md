...
> Read this first. Once the analogy clicks, the [deep-dive doc](./volume-snapshots.md) becomes easy.
...
- [Deep-dive: volume-snapshots.md](./volume-snapshots.md) — covers the full CRD model, deletionPolicy, cross-namespace restore limitations, Velero integration, cost, and the quiesce pattern
