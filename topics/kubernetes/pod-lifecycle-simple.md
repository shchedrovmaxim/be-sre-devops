...
> Read this first. Once the analogy clicks, the [deep-dive doc](./pod-lifecycle.md) becomes easy.
...
When the airplane analogy feels obvious, jump to [`pod-lifecycle.md`](./pod-lifecycle.md). The deep-dive covers:
