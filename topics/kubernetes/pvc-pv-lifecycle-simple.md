...
> Read this first. Once the analogy clicks, the [deep-dive doc](./pvc-pv-lifecycle.md) becomes easy.
...
- [Deep-dive: pvc-pv-lifecycle.md](./pvc-pv-lifecycle.md) — covers the full state machine, the finalizer mechanism, orphaned PV recovery, StatefulSet PVC retention policy (v1.23+), and backup/restore patterns with VolumeSnapshots
