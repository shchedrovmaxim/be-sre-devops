...
- [Deep-dive: csi-architecture.md](./deep-dive.md) — covers sidecar containers in detail, the gRPC calls at each step, stale attachment debugging, and kubelet's role in node-side operations
