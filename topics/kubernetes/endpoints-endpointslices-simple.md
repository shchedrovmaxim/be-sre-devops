...
> Read this first. Once the analogy clicks, the [deep-dive doc](./endpoints-endpointslices.md) becomes easy.
...
- [Deep-dive: endpoints-endpointslices.md](./endpoints-endpointslices.md) — covers topology-aware routing, the mirroring controller, how kube-proxy consumes slices, and what happens to in-flight connections on slice updates
