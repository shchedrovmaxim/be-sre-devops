...
> Read this first. Once the analogy clicks, the [deep-dive doc](./security-context.md) becomes easy.
...
When the contractor analogy feels obvious, jump to [`security-context.md`](./security-context.md). The deep-dive covers:
