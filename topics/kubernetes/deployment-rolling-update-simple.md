...
> Read this first. Once the analogy clicks, the [deep-dive doc](./deployment-rolling-update.md) becomes easy.
...
When the relay-race handoff feels obvious, jump to [`deployment-rolling-update.md`](./deployment-rolling-update.md). The deep-dive covers:
