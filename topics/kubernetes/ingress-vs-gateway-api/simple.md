...
- [Deep-dive: ingress-vs-gateway-api.md](./deep-dive.md) — covers ReferenceGrant for cross-namespace routing, the major implementations (Istio, Cilium, Envoy Gateway, NGINX Gateway Fabric), migration strategy, and multi-cluster patterns
