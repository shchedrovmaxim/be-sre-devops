...
> Read this first. Once the analogy clicks, the [deep-dive doc](./pod-security-standards.md) becomes easy.
...
When the bouncer analogy feels obvious, jump to [`pod-security-standards.md`](./pod-security-standards.md). The deep-dive covers:
