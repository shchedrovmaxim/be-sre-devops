...
> Read this first. Once the analogy clicks, the [deep-dive doc](./simplicity.md) becomes obvious.
...
When the moat analogy and the "what problem am I solving" question feel obvious, jump to [`simplicity.md`](./simplicity.md). The deep-dive covers:
