...
> Read this first. Once the analogy clicks, the [deep-dive doc](./vault-eso-pattern.md) fills in the mechanics.
...
When the "Vault as bank vault, ESO as armored car" pattern and the secret-zero concept feel intuitive, jump to [`vault-eso-pattern.md`](./vault-eso-pattern.md). The deep-dive covers:
