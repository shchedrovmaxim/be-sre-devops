...
When the personal-shopper analogy and the SecretStore/ExternalSecret split feel obvious, jump to [`external-secrets-operator.md`](./deep-dive.md). The deep-dive covers:
