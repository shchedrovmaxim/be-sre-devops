...
| [sealed-secrets.md](./sealed-secrets.md) | Deep-dive | Sealed Secrets — RSA+AES mechanics, scope binding, key rotation, backup, multi-cluster failure | 2026-06-05 |
...
| [external-secrets-operator.md](./external-secrets-operator.md) | Deep-dive | ESO — full reconciliation loop, IRSA auth chain, generators, failure modes, Kyverno integration | 2026-06-05 |
...
| [sops.md](./sops.md) | Deep-dive | SOPS + age/KMS — DEK+KEK hybrid, `.sops.yaml` creation rules, ArgoCD+KSOPS integration | 2026-06-05 |
...
| [vault-eso-pattern.md](./vault-eso-pattern.md) | Deep-dive | Vault + ESO — HA Raft, auto-unseal, K8s auth, dynamic DB creds, 50-service design | 2026-06-05 |
...
| [secrets-comparison.md](./secrets-comparison.md) | Deep-dive | Decision matrix — full 8-dimension trade-off matrix, decision tree, Kyverno enforcement, Wiz bridge | 2026-06-05 |
