...
> Read this first. Once the analogy clicks, the [deep-dive doc](./iptables-nftables.md) becomes easy.
...
When the post office analogy feels obvious, jump to [`iptables-nftables.md`](./iptables-nftables.md). The deep-dive covers:
