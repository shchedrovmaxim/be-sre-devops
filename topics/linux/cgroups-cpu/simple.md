...
> Read this first. Once the intuition clicks, the [deep-dive doc](./deep-dive.md) becomes easy.
...
When the buffet analogy feels obvious, jump to [`cgroups-cpu.md`](./deep-dive.md). The deep-dive covers:
