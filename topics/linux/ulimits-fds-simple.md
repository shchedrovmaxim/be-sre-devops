...
> Read this first. Once the analogy clicks, the [deep-dive doc](./ulimits-fds.md) becomes easy.
...
When the key ring analogy feels obvious, jump to [`ulimits-fds.md`](./ulimits-fds.md). The deep-dive covers:
