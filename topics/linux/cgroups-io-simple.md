...
> Read this first. Once the analogy clicks, the [deep-dive doc](./cgroups-io.md) becomes easy.
...
When the toll booth analogy feels obvious, jump to [`cgroups-io.md`](./cgroups-io.md). The deep-dive covers:
