...
> Read this first. Once the analogy clicks, the [deep-dive doc](./runc-internals.md) becomes easy.
...
When the flat-pack analogy feels obvious, jump to [`runc-internals.md`](./runc-internals.md). The deep-dive covers:
