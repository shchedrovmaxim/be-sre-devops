...
> Read this first. Once the passport analogy clicks, the [deep-dive](./otel-conventions-sampling.md) becomes easy.
...
When the passport and border analogies are obvious, jump to [`otel-conventions-sampling.md`](./otel-conventions-sampling.md). The deep-dive covers:
