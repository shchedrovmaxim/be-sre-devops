...
> Read this first. Once the intake → sort → dispatch analogy clicks, the [deep-dive](./deep-dive.md) becomes easy.
...
When the sorting-facility analogy is obvious, jump to [`otel-collector.md`](./deep-dive.md). The deep-dive covers:
