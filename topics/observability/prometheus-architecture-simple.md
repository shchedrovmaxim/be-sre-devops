...
> Read this first. Once the pull-model analogy clicks, the [deep-dive](./prometheus-architecture.md) becomes easy.
...
When the reporter analogy is obvious, jump to [`prometheus-architecture.md`](./prometheus-architecture.md). The deep-dive covers:
