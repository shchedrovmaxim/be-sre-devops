...
> Start with [promql-essentials-simple.md](./simple.md) first. The odometer/speedometer framing is the spine.
...
This is the investigation pattern when Prometheus is OOMing — see [`cardinality-discipline.md`](../cardinality-discipline/deep-dive.md) for the full workflow.
