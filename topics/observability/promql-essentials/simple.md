...
> Read this first. Once the rate-vs-gauge intuition clicks, the [deep-dive](./deep-dive.md) becomes easy.
...
When rate/histogram/sum feel natural, jump to [`promql-essentials.md`](./deep-dive.md). The deep-dive covers:
