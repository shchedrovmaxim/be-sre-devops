...
> Read this first. Once the analogy clicks, the [deep-dive doc](./slos.md) becomes easy.
...
When the data-plan analogy and the "good / valid events" formulation feel obvious, jump to [`slos.md`](./slos.md). The deep-dive covers:
