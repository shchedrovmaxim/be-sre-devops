...
> Read this first. Once the library catalogue analogy clicks, the [deep-dive](./loki-cardinality.md) becomes easy.
...
When the library analogy is obvious, jump to [`loki-cardinality.md`](./loki-cardinality.md). The deep-dive covers:
