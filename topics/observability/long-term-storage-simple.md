...
> Read this first. Once the hot-desk vs archive-room analogy clicks, the [deep-dive](./long-term-storage.md) becomes easy.
...
When the hot-desk vs archive-room analogy clicks, jump to [`long-term-storage.md`](./long-term-storage.md). The deep-dive covers:
