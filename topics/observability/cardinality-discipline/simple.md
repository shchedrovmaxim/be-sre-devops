...
> Read this first. Once the "one drawer per unique combination" analogy clicks, the [deep-dive](./deep-dive.md) becomes easy.
...
When the filing-cabinet analogy is obvious, jump to [`cardinality-discipline.md`](./deep-dive.md). The deep-dive covers:
