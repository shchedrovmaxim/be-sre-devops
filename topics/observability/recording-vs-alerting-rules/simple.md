...
> Read this first. Once the prep-work analogy clicks, the [deep-dive](./deep-dive.md) becomes easy.
...
When the sous-chef analogy is obvious, jump to [`recording-vs-alerting-rules.md`](./deep-dive.md). The deep-dive covers:
