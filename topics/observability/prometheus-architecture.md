...
> Start with [prometheus-architecture-simple.md](./prometheus-architecture-simple.md) first if you haven't. The newspaper-reporter analogy is the spine.
