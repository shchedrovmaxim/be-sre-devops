...
> Read this first. Once the blueprint analogy clicks, the [deep-dive](./deep-dive.md) becomes easy.
...
When the blueprint analogy is obvious, jump to [`grafana-as-code.md`](./deep-dive.md). The deep-dive covers:
