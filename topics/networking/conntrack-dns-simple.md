...
> Read this first. Once the analogy clicks, the [deep-dive](./conntrack-dns.md) becomes easy.
...
When the coat-check analogy and the `insert_failed` counter feel obvious, jump to [`conntrack-dns.md`](./conntrack-dns.md). The deep-dive covers:
