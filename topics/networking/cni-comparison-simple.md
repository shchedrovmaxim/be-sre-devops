...
> Read this first. Once the analogy clicks, the [deep-dive](./cni-comparison.md) becomes easy.
...
When the highway analogy and the eBPF vs iptables distinction feel solid, jump to [`cni-comparison.md`](./cni-comparison.md). The deep-dive covers:
