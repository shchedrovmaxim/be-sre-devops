...
> Start with the [simple version](./conntrack-dns-simple.md) if you haven't. The coat-check analogy is the spine.
...
See [`coredns-nodelocal.md`](./coredns-nodelocal.md) for full details. Summary:
