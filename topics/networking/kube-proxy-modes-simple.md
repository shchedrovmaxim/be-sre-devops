...
> Read this first. Once the analogy clicks, the [deep-dive](./kube-proxy-modes.md) becomes easy.
...
When the switchboard analogy and O(N) vs O(1) distinction feel solid, jump to [`kube-proxy-modes.md`](./kube-proxy-modes.md). The deep-dive covers:
