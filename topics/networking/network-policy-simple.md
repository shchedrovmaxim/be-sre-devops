...
> Read this first. Once the analogy clicks, the [deep-dive](./network-policy.md) becomes easy.
...
When the badge-reader analogy and the kube-dns gotcha feel obvious, jump to [`network-policy.md`](./network-policy.md). The deep-dive covers:
