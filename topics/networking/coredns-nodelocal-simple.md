...
> Read this first. Once the analogy clicks, the [deep-dive](./coredns-nodelocal.md) becomes easy.
...
When the library floor-desk analogy and the conntrack→TCP detail feel obvious, jump to [`coredns-nodelocal.md`](./coredns-nodelocal.md). The deep-dive covers:
