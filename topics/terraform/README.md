...
| [remote-state.md](./remote-state/deep-dive.md) | Deep-dive | Remote state with S3 + DynamoDB locking | 2026-06-05 |
...
| [workspaces-vs-separate-state.md](./workspaces-vs-separate-state/deep-dive.md) | Deep-dive | Workspaces vs separate state per environment | 2026-06-05 |
| [modules-simple.md](./modules/simple.md) | Simple companion | Module discipline — when to write vs use registry | 2026-06-05 |
| [modules.md](./modules/deep-dive.md) | Deep-dive | Module discipline — when to write vs use registry | 2026-06-05 |
| [drift-detection-simple.md](./drift-detection/simple.md) | Simple companion | Drift detection | 2026-06-05 |
| [drift-detection.md](./drift-detection/deep-dive.md) | Deep-dive | Drift detection | 2026-06-05 |
...
| [pr-workflows.md](./pr-workflows/deep-dive.md) | Deep-dive | Atlantis / Spacelift / Terragrunt — PR-based workflows | 2026-06-05 |
