...
> Read this first. Once the analogy clicks, the [deep-dive](./drift-detection.md) has all the mechanics.
...
When the scheduled-plan mechanism and the exit-code pattern are obvious, jump to [`drift-detection.md`](./drift-detection.md). The deep-dive covers:
