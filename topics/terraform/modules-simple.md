...
> Read this first. Once the analogy clicks, the [deep-dive](./modules.md) has all the detail.
...
When the rule of three and the SemVer contract feel obvious, jump to [`modules.md`](./modules.md). The deep-dive covers:
