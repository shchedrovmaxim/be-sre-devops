...
> Read this first. Once the analogy clicks, the [deep-dive](./pr-workflows.md) has all the detail.
...
When the four-eyes analogy and the plan-comment-apply flow are obvious, jump to [`pr-workflows.md`](./pr-workflows.md). The deep-dive covers:
