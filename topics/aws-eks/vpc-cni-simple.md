...
> Read this first. Once the analogy clicks, the [deep-dive doc](./vpc-cni.md) becomes easy.
...
When the parking lot analogy and the ENI math feel obvious, jump to [`vpc-cni.md`](./vpc-cni.md). The deep-dive covers:
