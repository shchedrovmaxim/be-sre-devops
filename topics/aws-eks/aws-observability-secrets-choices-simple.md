...
> Read this first. Once the "right tool for the right job" frame clicks, the [deep-dive doc](./aws-observability-secrets-choices.md) will be straightforward.
...
If that came out clearly, jump to the [deep-dive](./aws-observability-secrets-choices.md).
...
When the "both, with Grafana" and "rotation = Secrets Manager" frames feel obvious, jump to [`aws-observability-secrets-choices.md`](./aws-observability-secrets-choices.md). The deep-dive covers:
