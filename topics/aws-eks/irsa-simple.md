...
> Read this first. Once the analogy clicks, the [deep-dive doc](./irsa.md) becomes easy.
...
When the concert ticket analogy and the "env vars → SDK → STS" flow feel obvious, jump to [`irsa.md`](./irsa.md). The deep-dive covers:
